...
public class JavaNodeFactory
{
    ...
    private <T, S extends T> T getValue(Object jsNode, String name, Class<S> clazz)
    {
        ...
        catch (NoSuchMethodException | SecurityException | IllegalAccessException | InstantiationException | ScriptException | IllegalArgumentException | InvocationTargetException e)
        {
            e.printStackTrace();
        }
        return result;
    ...
    private <T, S extends T> List<T> getValueList(Object jsNode, String name, Class<S> clazz)
    {
        ...
        catch (NoSuchMethodException | SecurityException | InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException | ScriptException e)
        {
            e.printStackTrace();
        }
    ...
    private <T, S extends T> T getObject(Object jsNode, String name, Class<S> clazz)
    {
        ...
        catch (NoSuchMethodException | SecurityException | InstantiationException | IllegalAccessException | InvocationTargetException | IllegalArgumentException | ScriptException e)
        {
            e.printStackTrace();
        }
        return result;
    ...
    private <T, S extends T> List<T> getObjectList(Object jsNode, String name, Class<S> clazz)
    {
        ...
        catch (NoSuchMethodException | SecurityException | InstantiationException | IllegalArgumentException | IllegalAccessException | ScriptException | InvocationTargetException e)
        {
            e.printStackTrace();
        }
        return list;
